...
<head>
    ...
    <link href="<?php echo HOME_URL; ?>Views\css\style1.css" rel="stylesheet">
        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="pofile.php" class="nav-link"><img src="<?php echo HOME_URL; ?>Views\img\icon-profile.svg" alt=""></a></li>
